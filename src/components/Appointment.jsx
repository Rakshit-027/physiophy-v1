      ...
      {!showConfirmation ? (
        <div className="appointment-content">
          <div className="booking-section">
            <h2><Calendar className="section-icon" /> Select Date & Time</h2>
            ...
            {selectedDate && (
              <div className="time-selection">
                <h3><Clock className="section-icon" /> Available Time Slots</h3>
          ...
          {selectedDate && selectedTime && (
            <div className="details-section">
              <h2><User className="section-icon" /> Your Details</h2>
